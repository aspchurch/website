...
if command -v convert &> /dev/null; then
    ...
    if [ -f "assets/images/cross1.png" ]; then
        convert assets/images/cross1.png -quality 85 -define webp:lossless=false assets/images/optimized/cross1.webp
        echo "   📄 cross1.png → cross1.webp"
    fi
...
echo "   • Logo (cross1.png): 40x40, 80x80, 120x120 (for different screen densities)"
